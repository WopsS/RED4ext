...
REDext::Launchers::BaseLauncher::BaseLauncher()
    : m_processInfo{ 0 }
{
}
...
std::error_code REDext::Launchers::BaseLauncher::CreateGame(wchar_t* aCmdLine)
{
...
void REDext::Launchers::BaseLauncher::ResumeGame()
{
    ResumeThread(m_processInfo.hThread);
}

void REDext::Launchers::BaseLauncher::TerminateGame()
{
    TerminateProcess(m_processInfo.hProcess, 1);
}

std::error_code REDext::Launchers::BaseLauncher::Inject(const std::wstring_view aModule,
