...
std::error_code REDext::App::Init()
{
    ...
    spdlog::info(L"REDext loader started");
    return {};
}

std::error_code REDext::App::Run(wchar_t* aCmdLine)
{
    spdlog::info(L"Detecting launcher...");

    using namespace REDext::Launchers;
...
std::error_code REDext::App::Shutdown()
{
