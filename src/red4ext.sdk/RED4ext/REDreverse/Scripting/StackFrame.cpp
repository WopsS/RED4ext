...
namespace
{
    ...
    using CScriptableStackFrame_ctor_t = CScriptableStackFrame* (*)(CScriptableStackFrame* aThis,
                                                                    Scripting::IScriptable* aScriptable,
                                                                    CScriptableStackFrame::CStackType* aArgs,
                                                                    uint32_t aArgsCount,
                                                                    CScriptableStackFrame::CStackType* aResult,
                                                                    int64_t a6);
    RED4ext::REDfunc<CScriptableStackFrame_ctor_t> CScriptableStackFrame_ctor(
...
RED4ext::REDreverse::CScriptableStackFrame* RED4ext::REDreverse::CScriptableStackFrame::Construct(
  CScriptableStackFrame* aThis, Scripting::IScriptable* aScriptable, CScriptableStackFrame::CStackType* aArgs,
  uint32_t aArgsCount, CScriptableStackFrame::CStackType* aResult, int64_t a6)
{
