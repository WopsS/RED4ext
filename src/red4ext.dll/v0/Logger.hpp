...
void Debug(RED4ext::PluginHandle aHandle, const wchar_t* aMessage);
...
void Info(RED4ext::PluginHandle aHandle, const wchar_t* aMessage);
...
void Warn(RED4ext::PluginHandle aHandle, const wchar_t* aMessage);
...
void Error(RED4ext::PluginHandle aHandle, const wchar_t* aMessage);
...
void Critical(RED4ext::PluginHandle aHandle, const wchar_t* aMessage);
