...
void REDext::PluginManager::Init(HMODULE aModule, std::filesystem::path aDocsPath)
...
void REDext::PluginManager::Shutdown()
{
...
void REDext::PluginManager::Call(Callback aCallback)
{
    for (auto& plugin : m_plugins)
    {
        switch (aCallback)
