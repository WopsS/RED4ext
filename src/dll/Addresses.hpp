...
constexpr uintptr_t Global_ExecuteProcess = 0x142C2B960 - ImageBase; // 48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 40 48 8B FA 48 8B F1 48 8D 54 24 30 49 8B C9 49 8B D8, expected: 1, index: 0
#pragma endregion
} // namespace Addresses
